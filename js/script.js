...
function generateResult() {
    ...
    const powerState1LevelFrom = document.getElementById('power-state-1-level-from').value;
    const powerState1LevelTo = document.getElementById('power-state-1-level-to').value;

    const powerState2 = document.getElementById('power-state-2').value;
    const powerState2LevelFrom = document.getElementById('power-state-2-level-from').value;
    const powerState2LevelTo = document.getElementById('power-state-2-level-to').value;

    const powerState3 = document.getElementById('power-state-3').value;
    const powerState3LevelFrom = document.getElementById('power-state-3-level-from').value;
    const powerState3LevelTo = document.getElementById('power-state-3-level-to').value;
    ...
    const bandState1LevelFrom = document.getElementById('band-state-1-level-from').value;
    const bandState1LevelTo = document.getElementById('band-state-1-level-to').value;

    const bandState2 = document.getElementById('band-state-2').value;
    const bandState2LevelFrom = document.getElementById('band-state-2-level-from').value;
    const bandState2LevelTo = document.getElementById('band-state-2-level-to').value;

    const bandState3 = document.getElementById('band-state-3').value;
    const bandState3LevelFrom = document.getElementById('band-state-3-level-from').value;
    const bandState3LevelTo = document.getElementById('band-state-3-level-to').value;
...
# vtx
vtx 3 ${bandSelect} ${bandState1} 0 0 ${bandState1LevelFrom} ${bandState1LevelTo}
